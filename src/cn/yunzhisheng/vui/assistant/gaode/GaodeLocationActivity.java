...
import cn.yunzhisheng.vui.assistant.baidu.LocationOverlayActivity;
 ...
 * 2014-2-24: 实现基本功能
 */
public class GaodeLocationActivity extends Activity implements LocationSource, OnPoiSearchListener, OnMapLoadedListener {
	...
	private void queryLocation() {
		...
		String title = "";
		String content = "";
		double lat = start.getDoubleExtra(LocationOverlayActivity.TAG_LAT, 0);
		double lng = start.getDoubleExtra(LocationOverlayActivity.TAG_LNG, 0);
		title = start.getStringExtra(LocationOverlayActivity.TAG_TITLE);
		content = start.getStringExtra(LocationOverlayActivity.TAG_CONTENT);

		MarkerOptions option = new MarkerOptions();
		LogUtil.d(TAG, "queryLocation: title " + title + ", content: " + content + "\n" + ",lat: " + lat + ", lng: "
						+ lng);
	...
	public void activate(OnLocationChangedListener listener) {
		...
		mLocation.requestLocationUpdates(LocationProviderProxy.AMapNetwork, 5000, 10, new AMapLocationListener() {
