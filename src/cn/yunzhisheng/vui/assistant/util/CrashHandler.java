...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	//Log文件
	private static final String PATH = Environment.getExternalStorageDirectory().getPath() + "/YunZhiSheng/crash/";  
    private static final String FILE_NAME = "vui_car_crash.txt";  
